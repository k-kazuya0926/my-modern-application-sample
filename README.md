...
### 8. fan-out
**概要**: ファンアウトパターンによるメッセージ配信システム\
**機能**:
- 1つのイベントから複数のLambda関数へ並列処理
- 複数のコンシューマーが独立してメッセージを処理
- 非同期処理による高可用性とスケーラビリティの実現

**構成要素**:
- **fan-out-consumer-1**: 第1コンシューマーLambda関数
- **fan-out-consumer-2**: 第2コンシューマーLambda関数
